(function() {
    // --- WAIT FOR PAGE TO LOAD (Prevents the "Null" Error) ---
    window.addEventListener('DOMContentLoaded', () => {

        // --- CONFIGURATION: Standard STS Pages ---
        ...
        // This ensures body exists before appending
        ...
        async function detectPages() {
            ...
            for (const page of potentialPages) {
                try {
                    // Check if current page OR ping file
            ...
            if (foundCount === 0) {
                container.innerHTML = '<div class="sts-loading">No linked pages found.</div>';
            }
        }
